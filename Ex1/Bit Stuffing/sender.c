...
void bit_stuff(const char *in_data, char *out_data)
{
    int i, j = 0, count = 0;
...
int main()
{
    ...
    printf("--- PART 5B: BIT STUFFING & TRANSMISSION LAYER ---\n");
    ...
    for (i = 0; i < total_frames; i++)
    {
        char stuffed_data[50] = {0};
        bit_stuff(frames[i].data, stuffed_data);

        char final_frame[300] = {0};
        ...
        strcat(final_frame, stuffed_data);   // Stuffed Data Field
